...
recordLayout->addWidget(new QComboBox(this), 0, 1);
...
recordLayout->addWidget(new QDateEdit(this), 1, 1);
...
recordLayout->addWidget(new QComboBox(this), 2, 1);
...
recordLayout->addWidget(new QComboBox(this), 3, 1);
